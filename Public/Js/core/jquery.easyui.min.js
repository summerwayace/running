...
if(_closedTitle) _Cstitle = _closedTitle;
else _Cstitle = ' ';
...
p.panel($.extend({},$.fn.layout.paneldefaults,{cls:("layout-expand layout-expand-"+dir),title:_Cstitle,closed:true,doSize:false,tools:[{iconCls:icon,handler:function(){
_381(_376,_377);
return false;
}}]}));
